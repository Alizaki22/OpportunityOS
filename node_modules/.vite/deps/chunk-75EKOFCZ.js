...
} from "./chunk-S7VZTL47.js";
import {
  init_sha2,
  sha256,
  sha384,
  sha512
} from "./chunk-TUOJNPGF.js";
import {
  init_sha3,
  keccak_256
} from "./chunk-BGDGAPPF.js";
import {
  __export
...
function fromPublicKey2(publicKey) {
  const pkBytes = toBytes3(publicKey);
...
var InvalidCoseKeyError = class extends BaseError2 {
  constructor() {
...
var CreateFailedError = class extends BaseError2 {
  constructor({ cause } = {}) {
...
function getAuthenticatorData(options = {}) {
  ...
  const base2 = concat2(rpIdHash, flag_bytes, signCount_bytes);
  if (!credential)
    return base2;
  ...
  return concat2(base2, aaguid, credIdLen, credentialId, coseKey);
}
...
var SignFailedError = class extends BaseError2 {
  constructor({ cause } = {}) {
...
function verify3(options) {
  ...
  if (clientData.type !== "webauthn.get")
    return false;
  if (!clientData.challenge || fromBytes(toBytes4(clientData.challenge)) !== challenge)
    return false;
  if (origin !== void 0) {
  ...
  if (!transaction.from && signatureEnvelope) {
    try {
      transaction.from = extractAddress({
        payload: getSignPayload5(from13(transaction)),
        signature: signatureEnvelope,
        root: true
      });
    } catch {
    ...
    if (options.format === "feePayer" && signature) {
      ...
      if (sig.type === "secp256k1")
        return recoverAddress({
          payload: getSignPayload5(from13(envelope)),
...
async function resolveNode() {
  ...
  const { wasmBase64 } = await import("./mine.wasm-5SGETZGN.js");
...
@noble/curves/esm/p256.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=chunk-75EKOFCZ.js.map
