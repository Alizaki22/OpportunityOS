...
import {
  ...
  arraysEqual,
  bytesEqual
} from "./chunk-EPBSJTGS.js";
import {
  SOLANA_MAINNET_CHAIN,
  createSignInMessageText,
  getChainForEndpoint,
  getCommitment
} from "./chunk-TAY3BQ32.js";
import {
  Connection,
  PublicKey,
  Transaction,
...
var BaseSolanaMobileWalletAdapter = (_a7 = class extends BaseSignInMessageSignerWalletAdapter {
  ...
  async signMessage(message) {
    return await __privateMethod(this, _BaseSolanaMobileWalletAdapter_instances, runWithGuard_fn).call(this, async () => {
      ...
      try {
        ...
        throw new WalletSignMessageError(getErrorMessage2(error), error);
      }
    });
  }
  async sendTransaction(transaction, connection, options) {
    return await __privateMethod(this, _BaseSolanaMobileWalletAdapter_instances, runWithGuard_fn).call(this, async () => {
      ...
      try {
        ...
        throw new WalletSendTransactionError(getErrorMessage2(error), error);
      }
    });
  }
  ...
  try {
    ...
    throw new WalletSignTransactionError(getErrorMessage2(error), error);
  }
}, runWithGuard_fn = async function(callback) {
  try {
    return await callback();
  } catch (e2) {
    this.emit("error", e2 instanceof WalletError ? e2 : new WalletError(getErrorMessage2(e2), e2));
    throw e2;
  }
}, _a7);
...
_StandardWalletAdapter_account = /* @__PURE__ */ new WeakMap(), _StandardWalletAdapter_publicKey = /* @__PURE__ */ new WeakMap(), _StandardWalletAdapter_connecting = /* @__PURE__ */ new WeakMap(), _StandardWalletAdapter_disconnecting = /* @__PURE__ */ new WeakMap(), _StandardWalletAdapter_off = /* @__PURE__ */ new WeakMap(), _StandardWalletAdapter_supportedTransactionVersions = /* @__PURE__ */ new WeakMap(), _StandardWalletAdapter_wallet = /* @__PURE__ */ new WeakMap(), _StandardWalletAdapter_readyState = /* @__PURE__ */ new WeakMap(), _StandardWalletAdapter_changed = /* @__PURE__ */ new WeakMap(), _StandardWalletAdapter_instances = /* @__PURE__ */ new WeakSet(), _StandardWalletAdapter_connect = async function _StandardWalletAdapter_connect2(input) {
  ...
  if (SolanaSignTransaction in __classPrivateFieldGet(this, _StandardWalletAdapter_wallet, "f").features && ((_a8 = __classPrivateFieldGet(this, _StandardWalletAdapter_account, "f")) == null ? void 0 : _a8.features.includes(SolanaSignTransaction))) {
...
var SolanaWalletAdapterWalletAccount = class _SolanaWalletAdapterWalletAccount extends ReadonlyWalletAccount {
  constructor({ adapter, address, publicKey, chains }) {
    ...
    __classPrivateFieldSet2(this, _SolanaWalletAdapterWalletAccount_adapter, adapter, "f");
  }
};
...
_SolanaWalletAdapterWallet_listeners = /* @__PURE__ */ new WeakMap(), _SolanaWalletAdapterWallet_adapter = /* @__PURE__ */ new WeakMap(), _SolanaWalletAdapterWallet_supportedTransactionVersions = /* @__PURE__ */ new WeakMap(), _SolanaWalletAdapterWallet_chain = /* @__PURE__ */ new WeakMap(), _SolanaWalletAdapterWallet_endpoint = /* @__PURE__ */ new WeakMap(), _SolanaWalletAdapterWallet_account = /* @__PURE__ */ new WeakMap(), _SolanaWalletAdapterWallet_connect = /* @__PURE__ */ new WeakMap(), _SolanaWalletAdapterWallet_disconnect = /* @__PURE__ */ new WeakMap(), _SolanaWalletAdapterWallet_on = /* @__PURE__ */ new WeakMap(), _SolanaWalletAdapterWallet_signAndSendTransaction = /* @__PURE__ */ new WeakMap(), _SolanaWalletAdapterWallet_signTransaction = /* @__PURE__ */ new WeakMap(), _SolanaWalletAdapterWallet_signMessage = /* @__PURE__ */ new WeakMap(), _SolanaWalletAdapterWallet_signIn = /* @__PURE__ */ new WeakMap(), _SolanaWalletAdapterWallet_instances = /* @__PURE__ */ new WeakSet(), _SolanaWalletAdapterWallet_connected = function _SolanaWalletAdapterWallet_connected2() {
  var _a8;
  const publicKey = (_a8 = __classPrivateFieldGet2(this, _SolanaWalletAdapterWallet_adapter, "f").publicKey) == null ? void 0 : _a8.toBytes();
  if (publicKey) {
    const address = __classPrivateFieldGet2(this, _SolanaWalletAdapterWallet_adapter, "f").publicKey.toBase58();
    const account = __classPrivateFieldGet2(this, _SolanaWalletAdapterWallet_account, "f");
    if (!account || account.address !== address || account.chains.includes(__classPrivateFieldGet2(this, _SolanaWalletAdapterWallet_chain, "f")) || !bytesEqual(account.publicKey, publicKey)) {
      __classPrivateFieldSet2(this, _SolanaWalletAdapterWallet_account, new SolanaWalletAdapterWalletAccount({
        adapter: __classPrivateFieldGet2(this, _SolanaWalletAdapterWallet_adapter, "f"),
        address,
        publicKey,
        chains: [__classPrivateFieldGet2(this, _SolanaWalletAdapterWallet_chain, "f")]
      }), "f");
      __classPrivateFieldGet2(this, _SolanaWalletAdapterWallet_instances, "m", _SolanaWalletAdapterWallet_emit).call(this, "change", { accounts: this.accounts });
    }
  }
}, _SolanaWalletAdapterWallet_disconnected = function _SolanaWalletAdapterWallet_disconnected2() {
  if (__classPrivateFieldGet2(this, _SolanaWalletAdapterWallet_account, "f")) {
    __classPrivateFieldSet2(this, _SolanaWalletAdapterWallet_account, void 0, "f");
    __classPrivateFieldGet2(this, _SolanaWalletAdapterWallet_instances, "m", _SolanaWalletAdapterWallet_emit).call(this, "change", { accounts: this.accounts });
  }
}, _SolanaWalletAdapterWallet_emit = function _SolanaWalletAdapterWallet_emit2(event, ...args) {
  var _a8;
  (_a8 = __classPrivateFieldGet2(this, _SolanaWalletAdapterWallet_listeners, "f")[event]) == null ? void 0 : _a8.forEach((listener) => listener.apply(null, args));
}, _SolanaWalletAdapterWallet_off = function _SolanaWalletAdapterWallet_off2(event, listener) {
  var _a8;
  __classPrivateFieldGet2(this, _SolanaWalletAdapterWallet_listeners, "f")[event] = (_a8 = __classPrivateFieldGet2(this, _SolanaWalletAdapterWallet_listeners, "f")[event]) == null ? void 0 : _a8.filter((existingListener) => listener !== existingListener);
  ...
  if (!__classPrivateFieldGet2(this, _SolanaWalletAdapterWallet_supportedTransactionVersions, "f").includes(transaction.version))
    throw new Error("unsupported transaction version");
  if (transaction.version === "legacy" && arraysEqual(__classPrivateFieldGet2(this, _SolanaWalletAdapterWallet_supportedTransactionVersions, "f"), ["legacy"]))
...
//# sourceMappingURL=chunk-B6BAOQB2.js.map
